...
/**
 * Item in *SwicthPlayground → Default → Primary → Switches*
 */
export interface SlicePlaygroundSliceDefaultPrimarySwitchesItem {
  /**
   * Switch field in *SwicthPlayground → Default → Primary → Switches*
   *
...
/**
 * Primary content in *SwicthPlayground → Default → Primary*
 */
export interface SlicePlaygroundSliceDefaultPrimary {
  /**
   * Heading field in *SwicthPlayground → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
  ...
  /**
   * Description field in *SwicthPlayground → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
  ...
  /**
   * Switches field in *SwicthPlayground → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
...
/**
 * Default variation for SwicthPlayground Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slices
...
/**
 * Slice variation for *SwicthPlayground*
 */
type SlicePlaygroundSliceVariation = SlicePlaygroundSliceDefault;

/**
 * SwicthPlayground Shared Slice
 *
